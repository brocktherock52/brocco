  ...
  return (
    <ComparePage
      ...
      hero={{
        ...
        subtitle:
          'Devin is a single autonomous engineer that takes a ticket and ships a PR. Brocco is a multi-agent dashboard where you watch your AI team run in parallel on whatever your day requires. Different bets, different prices.',
      }}
      oneLine={{
        brocco:
