...
// Each entry binds an agent slug to an image (or video) + scene
// caption. Images live in public/assets/cast/<slug>.jpg, generated
// via scripts/gen-cast-variants.mjs (sharp + svg compositing).
...
export const AGENT_CAST: AgentCastMember[] = [
  {
    ...
    imagePath: '/assets/cast/researcher-v3.jpg',
    videoPath: null,
    accent: '#67E8F9',
  },
  {
    ...
    imagePath: '/assets/cast/planner-v3.jpg',
    videoPath: null,
    accent: '#FB7185',
  },
  {
    ...
    imagePath: '/assets/cast/outreach-v3.jpg',
    videoPath: null,
    accent: '#FBBF24',
  },
  {
    ...
    imagePath: '/assets/cast/designer-v3.jpg',
    videoPath: null,
    accent: '#F472B6',
  },
  {
    ...
    imagePath: '/assets/cast/analyst-v3.jpg',
    videoPath: null,
    accent: '#A78BFA',
  },
  {
    ...
    imagePath: '/assets/cast/coder-v3.jpg',
    videoPath: null,
    accent: '#4ADE80',
  },
  {
    ...
    imagePath: '/assets/cast/ops-v3.jpg',
    videoPath: null,
    accent: '#22D3EE',
  },
  {
    ...
    imagePath: '/assets/cast/supervisor-v3.jpg',
    videoPath: null,
    accent: '#22C55E',
  },
  {
    ...
    imagePath: '/assets/cast/browser-v3.jpg',
    videoPath: null,
    accent: '#67E8F9',
  },
];
